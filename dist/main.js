...
function appendDayofWeek(date) {
  const parsedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.parseISO)(date);
  const dayOfWeek = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(parsedDate, "EEEE");
...
function displayHourlyForecast(forecastData) {
  ...
  for (let i = currentTime + 1; i <= today.length - 1; i++) {
    ...
    time.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date().setHours(i), "ha");
