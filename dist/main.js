...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_forecast__WEBPACK_IMPORTED_MODULE_1__]);
_forecast__WEBPACK_IMPORTED_MODULE_1__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];




let defaultWeather = await (0,_API__WEBPACK_IMPORTED_MODULE_0__.getWeather)("flagstaff");
let degrees;
let feelsLike;
let wind;
...
function displayWeatherData(weatherData) {
  if (_forecast__WEBPACK_IMPORTED_MODULE_1__.measurementFlags.f) {
...
function formateDate(weather) {
  ...
  const dateObject = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.parseISO)(unformattedDate);
  const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(dateObject, "eeee, do MMM ''yy h:mm a");
...
async function getSearchedLocation(value) {
  return await (0,_API__WEBPACK_IMPORTED_MODULE_0__.getWeather)(value);
}
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   measurementFlags: () => (/* binding */ measurementFlags)
/* harmony export */ });
/* harmony import */ var _API__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./API */ "./src/API.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/parseISO.mjs");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/format.mjs");
/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dom */ "./src/dom.js");
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_dom__WEBPACK_IMPORTED_MODULE_1__]);
_dom__WEBPACK_IMPORTED_MODULE_1__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];




let defaultForecast = await (0,_API__WEBPACK_IMPORTED_MODULE_0__.getForecast)("flagstaff");
...
function appendDayofWeek(date) {
  ...
  const dayOfWeek = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(parsedDate, "EEEE");
...
function displayHourlyForecast(forecastData) {
  ...
  for (let i = currentTime + 1; i <= today.length - 1; i++) {
    ...
    time.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(new Date().setHours(i), "ha");
...
document.querySelector(".searchBtn").addEventListener("click", () => {
  ...
  errmsg.textContent = "";
  (0,_API__WEBPACK_IMPORTED_MODULE_0__.getForecast)(document.getElementById("search").value)
    .then((data) => {
...
document.querySelector(".f").addEventListener("click", () => {
  ...
  (0,_dom__WEBPACK_IMPORTED_MODULE_1__["default"])(previousCast);
  determineRerun();
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (displayDailyForcast);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_dom__WEBPACK_IMPORTED_MODULE_1__, _forecast__WEBPACK_IMPORTED_MODULE_2__]);
([_dom__WEBPACK_IMPORTED_MODULE_1__, _forecast__WEBPACK_IMPORTED_MODULE_2__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
