...
function formateDate(weather) {
  ...
  const dateObject = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.parseISO)(unformattedDate);
  const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(dateObject, "eeee, do MMM ''yy h:mm a");
